...
public static class LocalizationManager
{
    ...
    private static readonly List<Entry> Entries = new List<Entry>
    {
        ...
        new Entry(
            ...
            "참새 이등병이 재정비 중입니다."),
        new Entry("Sparrow down...", "참새 이등병 작전 불능..."),
        new Entry("Charge power", "전력 충전"),
        new Entry(
        ...
        new Entry("Health", "참새 이등병 체력"),
        new Entry("Hero Health", "참새 이등병 체력"),
        new Entry("Damage Reduction", "피해감소"),
        new Entry("Attack Speed", "공격 속도"),
        new Entry("Increase damage", "피해량 증가"),
        new Entry("Increase maximum HP", "참새 이등병 체력 증가"),
        new Entry("Increase sparrow health", "참새 이등병 체력 증가"),
