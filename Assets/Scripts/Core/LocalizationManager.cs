...
public static class LocalizationManager
{
    ...
    private static readonly List<Entry> Entries = new List<Entry>
    {
        ...
        new Entry("CONFIRM", "확인"),
        new Entry("AUTO BATTLE", "자동 전투"),
        new Entry("AUTO ON", "자동 진행"),
        new Entry("BOSS", "보스"),
        new Entry("BOSS FAILED", "보스 도전 실패"),
        new Entry("BOSS SKILL", "보스 스킬"),
        new Entry("HERO", "영웅"),
        new Entry("SUPPORT SPARROW", "참새 이등병"),
        new Entry("PWR", "전력"),
        new Entry("CHARGE", "충전"),
        new Entry("CHARGE POWER", "전력 충전"),
        new Entry("Power Charge", "전력"),
        new Entry("Charge", "충전"),
        ...
        new Entry("BOSS WARNING", "보스 경고"),
        new Entry("Incoming", "다가옴"),
        new Entry("ART NEEDED / STAGE BACKGROUND", "아트 필요 / 스테이지 배경"),
        new Entry(
            "Spend Gold to reinforce the line.",
            "골드를 사용해 전봇대를 보강하세요."),
        new Entry(
            "Spend Gold to reinforce the pole.",
            "골드를 사용해 전봇대를 보강하세요."),
        new Entry("Attack", "공격력"),
        new Entry("Health", "전봇대 내구도"),
        new Entry("Pole Durability", "전봇대 내구도"),
        new Entry("Line Defense", "전봇대 내구도"),
        new Entry("Line DEF", "내구도"),
        new Entry("DUR", "내구도"),
        new Entry("Damage Reduction", "피해감소"),
        new Entry("Attack Speed", "공격 속도"),
        new Entry("Increase damage", "피해량 증가"),
        new Entry("Increase maximum HP", "전봇대 내구도 증가"),
        new Entry("Increase pole durability", "전봇대 내구도 증가"),
        new Entry("Attack more frequently", "더 자주 공격"),
        new Entry("RESOURCES", "자원"),
        new Entry(
        ...
        new Entry("GOLD", "골드"),
        new Entry(
            "Real purchases and rewarded ads are SDK-ready placeholders.",
            "실제 결제와 광고 보상 SDK 연결 준비 화면입니다."),
        new Entry("BUY GOLD POUCH", "골드 주머니 구매"),
        new Entry("RESTORE PURCHASES", "구매 복원"),
        new Entry("EVENT MISSIONS", "이벤트 미션"),
        new Entry(
            "Prototype event loop for future live ops.",
            "추후 라이브 운영을 위한 이벤트 기본 구조입니다."),
        new Entry(
        ...
        new Entry(
            ...
            "Android 빌드는 Google 로그인 또는 게스트 플레이를 사용합니다."),
        new Entry(
            "Link Google to protect guest progress on Android.",
            "Android에서 게스트 진행도를 보호하려면 Google과 연동하세요."),
        ...
        new Entry(
            ...
            "티켓 1개 또는 젬 100개가 필요합니다."),
        new Entry(
            "Need 10 Tickets or 900 Gems.",
            "티켓 10개 또는 젬 900개가 필요합니다."),
        new Entry("Used", "사용"),
