...
public static class LocalizationManager
{
    ...
    private static readonly List<Entry> Entries = new List<Entry>
    {
        ...
        new Entry("Skill is not ready.", "스킬 준비 중입니다."),
        new Entry("Power charger is not ready.", "전력 충전기를 사용할 수 없습니다."),
        new Entry("Charge power", "전력 충전"),
        new Entry("Charge power once to support your companions.", "전력 충전을 한 번 눌러 동료를 지원하세요."),
